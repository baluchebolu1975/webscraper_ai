...
class AIAnalyzer:
    ...
    def analyze_sentiment(self, text: str) -> dict[str, Any]:
        ...
        system_message = "You are an expert in sentiment analysis. Provide detailed and accurate analysis."
    ...
    def extract_keywords(self, text: str, num_keywords: int = 10) -> list[str]:
        ...
        Returns:
            List of keywords
        """
        prompt = f"""Extract the {num_keywords} most important keywords or key phrases from the following text.
